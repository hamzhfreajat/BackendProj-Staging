...
with open('final_queries_multi.txt', 'r', encoding='utf-8') as f:
...
{{
  ...
  "raw_filters": {{
    "property_type": "Extract property type (e.g. شقة, فيلا, ارض, محل, مزرعة, شاليه, مكتب)",
    ...
    "floor_words": ["Subset of EXACT strings: [تسوية, ارضي, اول, ثاني, ثالث, رابع, خامس, سادس, روف]"],
    "floor_numbers": ["Array of integers e.g. [-1, 0, 1]"],
    ...
    "building_age": "MUST be exactly one of: [0 - 11 شهر, 1 - 5 سنوات, 6 - 9 سنوات, 10 - 19 سنوات, +20 سنة] or null. IMPORTANT: If user says 'عادي قديم' (doesn't care if old), leave it null! Only set if they strictly require a specific age.",
...
xls_path = 'C:/Users/hfraijat/.gemini/antigravity/brain/696fb396-0dce-4ae5-a16f-7a3bb2cd2761/full_test_results_multi.xls'

html = '''<html xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:x="urn:schemas-microsoft-com:office:excel" xmlns="http://www.w3.org/TR/REC-html40">
<head><meta http-equiv="Content-type" content="text/html;charset=utf-8" /></head><body><table border="1">'''

headers = ["Query", "Intent", "Property", "Transaction", "Locations", "Min Price", "Max Price", "Min Area", "Max Area", "Beds", "Baths", "Furnished", "Floor Words", "Floor Nums", "Rent Period", "Building Age", "Interface", "Nearby", "Main Features", "Extra Features", "Prompt Tokens", "Completion Tokens", "Total Tokens"]
...
for q, res in results:
    if "error" in res:
        ...
        row = [
            ...
            ', '.join(f.get('floor_words', [])) if f.get('floor_words') else '-',
            ', '.join([str(num) for num in f.get('floor_numbers', [])]) if f.get('floor_numbers') else '-',
